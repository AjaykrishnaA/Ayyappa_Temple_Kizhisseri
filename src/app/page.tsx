        ...
        <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center text-center text-white">
          ...
          <div className="relative z-10 container px-4">
            <h1 className="font-headline text-4xl md:text-6xl font-bold tracking-tight drop-shadow-lg">
              Welcome to Kizhisseri Ayyappan Temple
            </h1>
          ...
          <div className="container px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <p className="font-body text-muted-foreground">The Kizhisseri Ayyappan Temple has a rich history that dates back several centuries. It has been a spiritual center for the local community, witnessing generations of devotees who have come to seek blessings and solace. The temple's architecture reflects traditional Kerala style.</p>
                </CardContent>
              </Card>
              <Card className="shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader>
